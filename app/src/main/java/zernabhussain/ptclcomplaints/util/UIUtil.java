package zernabhussain.ptclcomplaints.util;
...
public class UIUtil {
    ...
    private static void hideKeyboard(Activity ba) {
    ...
    private static void hideSoftKeyOutsideET(final Activity a, View view) {
